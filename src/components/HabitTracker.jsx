      ...
      <div className="max-w-4xl mx-auto">
        ...
        {habits.length === 0 && !isAddingHabit ? (
          <div className="text-center mb-8">
            <div className="text-2xl font-bold tracking-widest uppercase text-indigo-500 dark:text-indigo-400">Beacon</div>
          ...
          <div className="flex items-center gap-2 pb-3 mb-4 border-b border-indigo-100 dark:border-gray-800">
            ...
            <div className="flex-1 text-center">
              <div className="text-2xl font-bold tracking-widest uppercase text-indigo-500 dark:text-indigo-400 leading-tight">Beacon</div>
