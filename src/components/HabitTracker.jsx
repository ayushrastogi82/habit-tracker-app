...
import { Plus, Check, TrendingUp, Calendar, ChevronDown, ChevronLeft, ChevronRight, Flame, Undo2, Download, Upload, MoreHorizontal, Share2 } from 'lucide-react';
                      ...
                      <div className="flex flex-col justify-center items-end gap-0.5 shrink-0 mr-1.5">
                        ...
                        {isWeekly ? (
                          weeklyStreak.current >= 1
                            ? <span className={`w-16 py-0.5 rounded-full text-xs font-semibold flex items-center justify-center gap-0.5 ${weekGoalMet ? 'bg-green-100 text-green-700' : 'bg-indigo-100 text-indigo-600'}`}>{weeklyStreak.current}w<Flame className="w-2.5 h-2.5" /></span>
                          ...
                          monthlyStreak.current >= 1
                            ? <span className={`w-16 py-0.5 rounded-full text-xs font-semibold flex items-center justify-center gap-0.5 ${monthGoalMet ? 'bg-green-100 text-green-700' : 'bg-indigo-100 text-indigo-600'}`}>{monthlyStreak.current}m<Flame className="w-2.5 h-2.5" /></span>
                          ...
                          streak.current > 1
                            ? <span className={`w-16 py-0.5 rounded-full text-xs font-semibold flex items-center justify-center gap-0.5 ${loggedToday ? 'bg-green-100 text-green-700' : 'bg-indigo-100 text-indigo-600'}`}>{streak.current}d<Flame className="w-2.5 h-2.5" /></span>
