                      ...
                      <div className="flex flex-col justify-center items-end gap-0.5 shrink-0 mr-1.5">
                        ...
                        {isWeekly ? (
                          weeklyStreak.current >= 1
                            ? <span className={`w-16 py-0.5 rounded-full text-white text-xs font-bold flex items-center justify-center gap-0.5 bg-gradient-to-r ${weekGoalMet ? 'from-green-300 to-green-500' : 'from-indigo-400 to-blue-500'}`}>{weeklyStreak.current}w<Rocket className="w-2.5 h-2.5" /></span>
                            : weeklyGap !== null && weeklyGap >= 1 ? <span className="w-16 py-0.5 rounded-full text-white text-xs font-bold flex items-center justify-center bg-gradient-to-r from-pink-300 to-red-400">{weeklyGap}w gap</span> : <div className="w-16" />
                        ) : isMonthly ? (
                          monthlyStreak.current >= 1
                            ? <span className={`w-16 py-0.5 rounded-full text-white text-xs font-bold flex items-center justify-center gap-0.5 bg-gradient-to-r ${monthGoalMet ? 'from-green-300 to-green-500' : 'from-indigo-400 to-blue-500'}`}>{monthlyStreak.current}m<Rocket className="w-2.5 h-2.5" /></span>
                            : monthlyGap !== null && monthlyGap >= 1 ? <span className="w-16 py-0.5 rounded-full text-white text-xs font-bold flex items-center justify-center bg-gradient-to-r from-pink-300 to-red-400">{monthlyGap}m gap</span> : <div className="w-16" />
                        ) : (
                          streak.current > 1
                            ? <span className={`w-16 py-0.5 rounded-full text-white text-xs font-bold flex items-center justify-center gap-0.5 bg-gradient-to-r ${loggedToday ? 'from-green-300 to-green-500' : 'from-indigo-400 to-blue-500'}`}>{streak.current}d<Rocket className="w-2.5 h-2.5" /></span>
                            : daysSince !== null && daysSince > 0 ? <span className="w-16 py-0.5 rounded-full text-white text-xs font-bold flex items-center justify-center bg-gradient-to-r from-pink-300 to-red-400">{daysSince}d gap</span> : <div className="w-16" />
                        )}
